          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12 max-w-6xl mx-auto items-stretch animate-in fade-in slide-in-from-bottom-8 duration-700">
             ...
             <div className="group relative bg-white rounded-3xl border border-slate-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 flex flex-col h-full overflow-hidden">
                ...
                <div className="p-8 pt-12 flex flex-col h-full">
                  ...
                  <div className="flex items-baseline mb-6"><span className="text-4xl font-bold text-slate-900">€2.50</span><span className="text-slate-400 ml-1">/ month</span></div>
             ...
             <div className="relative group md:-translate-y-4 h-full">
               ...
               <div className="relative bg-white rounded-[22px] shadow-2xl h-full flex flex-col border border-purple-100 transform transition-transform duration-300 group-hover:-translate-y-2 overflow-hidden">
                 <div className="absolute top-0 left-0 w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 text-center text-xs font-bold uppercase tracking-widest">BEST VALUE</div>
                 <div className="p-8 pt-12 flex flex-col h-full">
