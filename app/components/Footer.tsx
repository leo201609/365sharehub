      ...
      <div className="max-w-[1600px] mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://t.me/your_telegram_bot" target="_blank" className="text-slate-400 hover:text-blue-500 transition"><TelegramIcon className="w-5 h-5" /></a>
              </div>
            </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 text-xs text-slate-400">
          <div className="flex items-center font-medium">
             <div className="cursor-pointer hover:text-slate-800 transition-colors">
                <LanguageSwitcher />
             </div>
          </div>
